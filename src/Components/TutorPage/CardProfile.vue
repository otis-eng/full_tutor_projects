<template lang="">
    <div>
          <div class="card">
    <img v-bind:src=item.avatar width="200" height="200" >
    ...
    <button type="submit" class="btn draw-border" @click="acceptTutor">Accept</button>
    <button class="btn draw-border">Cancel</button>
  </div>
    </div>
</template>
<script>
